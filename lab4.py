...
num1 = int(input("Please enter a value for number1: "))
num2 = int(input("Please enter a value for number2 which is smaller then number1: "))

while 0 > num1 and num2 or num1 and num2 > 1000:
    print("Please enter numbers between 1-999")
    num1 = int(input("Please enter a value for number1: "))
    num2 = int(input("Please enter a value for number2: "))

while num1 < num2:
    print("Number1 should be greater than number2 ")
    num2 = int(input("Please enter a value for number2: "))
...
while True:
    ...
    if user_number >= 3 and user_number <= 7:
        ...
        print("Invalid number. Please enter a number between 3 and 7.")
...
# reverse the password and print it
print(password[::-1])
...
for i in range(8):
    ...
    # add password to shorter or longer set
    if user_number < 5:
        shorter.add(password)
    else:
        longer.add(password)

# combine sets and print
combined = shorter.union(longer)
...
key_to_be_delete = int(input("\nPlease enter the key , you want to delete: "))
if key_to_be_delete in dictionary:
    del dictionary[key_to_be_delete]
else:
...
print("\nMerged version is :", united_we_stand)
...
print("\nPrinting the items of united_we_stand in a sorted order by key.\n")
for key in sorted(united_we_stand):
    print("%s: %s" % (key, united_we_stand[key]))

key_max = max(united_we_stand.keys(), key=(lambda k: united_we_stand[k]))
key_min = min(united_we_stand.keys(), key=(lambda k: united_we_stand[k]))

print('\nMaximum Value: ', united_we_stand[key_max])
print('Minimum Value: ', united_we_stand[key_min])
